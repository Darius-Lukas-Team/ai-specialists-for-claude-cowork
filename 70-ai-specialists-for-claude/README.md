...
**Start here — run any of these five entry points: `/start-70`, `/ai-helper`, `/ai-helpers`, `/ai-specialist`, `/ai-specialists`.** They all behave the same. The first time you use one, it runs a ~2-minute setup: five quick questions that save a reusable Business Profile so every specialist sounds like you, then one finished asset plus a 14-day roadmap. Once your profile is saved, those same entry points skip setup and route straight to the right specialist, personalising the output from your profile.

Invoke any helper directly by typing `/skill-name` in chat, or let Claude use them automatically for relevant tasks.
...
| `/dina-digital-content` | Dina | Multi-platform digital content |

### Business (10)
| Skill | Persona | Specialty |
|-------|---------|-----------|
| `/titan-business-offer` | Titan | Business offers and value propositions |
| `/aurora-sales-negotiation` | Aurora | Sales negotiation coaching |
...
| `/cody-copywriting` | Cody | Strategic copywriting |
| `/juno-email-marketing` | Juno | Email marketing campaigns |
| `/dimarko-digital-marketing` | DiMarko | Digital marketing strategy |
| `/dipedi-product-development` | DiPeDi | Digital product development |
| `/mape-marketing-persona` | MaPe | Marketing copy and personas |
...
| `/lyra-customer-segmentation` | Lyra | Customer segmentation |
...
| `/victor-virtual-support` | Victor | Virtual support and product queries |

## License

Copyright (c) 2026 Hyper Entrepreneur. See [LICENSE](LICENSE) for details.
